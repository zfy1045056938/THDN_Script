...
public class TargetHealSkill : BounsSkill
{
    ...
    //    if (target != null)
    //    {
    //        destination = target.collider.ClosestPoint(caster.transform.position);
    ...
    public override void Apply(Entity caster, int skillLevel)
    {
        ...
        // {
        //     caster.target.health += healthMaxBonus.Get(skillLevel);
        //     caster.target.manaMax += manaMaxBonus.Get(skillLevel);
