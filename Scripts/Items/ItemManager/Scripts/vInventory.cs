...
namespace Invector.vItemManager
{
    ...
    public class vInventory : vMonoBehaviour
    {
        ...
        /// <summary>g3 the Inventory methods
        /// </summary>
        ...
        public virtual void OpenInventory()
        {
            ...
            //
            // p.gameObject.GetComponent<vMeleeCombatInput>().ShowCursor(true);
            
            // p.gameObject.GetComponent<vMeleeCombatInput>().LockCursor(true);
            
            // p.gameObject.GetComponent<vMeleeCombatInput>().SetLockAllInput(true);
            
            // p.gameObject.GetComponent<vMeleeCombatInput>().SetLockBasicInput(true);
            
            // p.gameObject.GetComponent<vMeleeCombatInput>().SetLockCameraInput(true);
 ...
 p.gameObject.GetComponent<vMeleeCombatInput>().ShowCursor(false);
            
            p.gameObject.GetComponent<vMeleeCombatInput>().LockCursor(false);
            
            p.gameObject.GetComponent<vMeleeCombatInput>().SetLockAllInput(false);
            
            p.gameObject.GetComponent<vMeleeCombatInput>().SetLockBasicInput(false);
            
            p.gameObject.GetComponent<vMeleeCombatInput>().SetLockCameraInput(false);
