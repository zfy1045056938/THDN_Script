...
namespace Invector.vItemManager
{
    ...
    public partial class vItemManager : vMonoBehaviour, IActionReceiver
    {
        ...
        public List<ItemReference> pitem = new List<ItemReference>();
        ...
        IEnumerator Start()
        {
            ...
            // Initialize Items  und load item
            // if(vSaveLoadInventory.InventoryDataFile!=null){
            // Debug.Log("Try Load Items"+vSaveLoadInventory.InventoryDataFile.ToString());
            ...
            //     AddItem(players.inventory[i].item,false);
            // }
        ...
        /// </summary>
        /// <param name="value"></param>
        public virtual void OnOpenCloseInventory(bool value)
        {
        ...
        public virtual void AddItem(ItemReference itemReference, bool ignoreItemAnimation = false)
        {
            ...
            {
                var item = itemListData.items.Find(t => t.itemID==itemReference.id);
                if (item !=null)
                {
                        Debug.Log("Item Got"+item.name.ToString());
        ...
        public virtual void AutoEquipItem(vItem item, int indexArea, bool autoEquip = false, bool ignoreItemAnimation = true)
        {
            ...
            //
            Debug.Log(ignoreItemAnimation+"Animation ignore");
            ...
            if (!inEquip)
            {
                ...
                if (equipPoint != null)
                {
                    if (item.originalObject)
                    {
                        ...
                        // players.vMeleeManager.SetRightWeapon(equipedObject.weapon);
                        //TODO
                        Debug.Log("Update Equip");
                        equipPoint.onInstantiateEquiment.Invoke(equipedObject.weapon);                       
                    }
        ...
        Debug.Log("Add items=>collection tips");
            ...
            for (int i = 0; i < collection.Count; i++)
            {
                ...
                {
                    vItemCollectionDisplay.Instance.FadeText("Got:" + " " + collection[i].amount + " " + item.name, 4, 0.25f);
                }
        ...
        {
            Debug.Log("Got item from object");
            ...
            if (collection != null)
            {
                if (collection.items.Count > 0)
                {
                    ...
                    StartCoroutine(CollectItemsWithDelay(itemCol, collection.onCollectDelay, 
                    collection.textDelay, collection.ignoreItemAnimation));
                }
            }
        }
    ...
    public class ItemReference
    {
        ...
        public ItemReference(int id)
        {
         ...
         public ItemReference(int id, string iname, int iamount)
        {
            this.id = id;
            this.name = iname;
            this.amount = iamount;
    ...
    public class EquipPoint
    {
        ...
        public OnInstantiateItemObjectEvents onInstantiateEquiment = new OnInstantiateItemObjectEvents();
        #endregion
    }
