...
//THDN NetworkManager,Server/Client Module With server und have a Database 
...
public class NetworkManagerWTS: NetworkManager
{
   // current network manager state on client
    ...
    {
        // filter out all Player prefabs from spawnPrefabss
    ...
    public override void Start()
    {
        ...
        // addon system hooks
        Util.InvokeMany(typeof(NetworkManagerWTS), this, "Start_");
        //
...
//        uiPop.Show(message.text);
    ...
    public override void OnStartClient()
    {
        ...
        // addon system hooks
        Util.InvokeMany(typeof(NetworkManagerWTS), this, "OnStartClient_");
    }
    ...
    public override void OnStopServer()
    {
        ...
        // addon system hooks
        Util.InvokeMany(typeof(NetworkManagerWTS), this, "OnStopServer_");
    }
    ...
    {
        // addon system hooks
        Util.InvokeMany(typeof(NetworkManagerWTS), this, "OnClientConnect_", conn);
    ...
    public override void OnServerConnect(NetworkConnection conn)
    {
        ...
        // addon system hooks
        Util.InvokeMany(typeof(NetworkManagerWTS), this, "OnServerConnect_", conn);
    }
   ...
   characters.Add(player.GetComponent<Players>());
    ...
    void OnClientCharactersAvailable(NetworkConnection conn, CharacterAvailableMsg message)
    {
        ...
        // addon system hooks
        Util.InvokeMany(typeof(NetworkManagerWTS), this, "OnClientCharactersAvailable_", charactersAvailableMsg);
    }
            ...
            // {
                ...
                if (!database.CharacterExists(message.names))
                {
                    ...
                    // player.portrainIcon =Sprite.Create(THDNGameDatabase.avaDic[message.iconName],new Rect(0,0, THDNGameDatabase.avaDic[message.iconName].width, THDNGameDatabase.avaDic[message.iconName].height),Vector2.zero);
                            ...
                            // addon system hooks
                            Util.InvokeMany(typeof(NetworkManagerWTS), this, "OnServerCharacterCreate_", message, player);
...
//               }
               ...
               mainCamera.depth = 1000;
                ...
                // addon system hooks
                Util.InvokeMany(typeof(NetworkManagerWTS), this, "OnServerCharacterSelect_", account, go, conn, message);
#pragma warning disable CS0618 // AddPlayerMessage.value is obsolete
                // Util.InvokeMany(typeof(NetworkManagerWTS), this, "OnServerAddPlayer_", account, go, conn, new AddPlayerMessage{ value=BitConverter.GetBytes(message.index) }); // old hook
#pragma warning restore CS0618 // AddPlayerMessage.value is obsolete
    ...
    void OnServerCharacterDelete(NetworkConnection conn, CharacterDeleteMsg message)
    {
        ...
        if (lobby.ContainsKey(conn))
        {
            ...
            if (0 <= message.index && message.index < characters.Count)
            {
                ...
                // addon system hooks
                Util.InvokeMany(typeof(NetworkManagerWTS), this, "OnServerCharacterDelete_", message);
    ...
    IEnumerator<WaitForSeconds> DoServerDisconnect(NetworkConnection conn, float delay)
    {
        ...
        // addon system hooks
        Util.InvokeMany(typeof(NetworkManagerWTS), this, "OnServerDisconnect_", conn);
    ...
    public override void OnClientDisconnect(NetworkConnection conn)
    {
        ...
        // addon system hooks
        Util.InvokeMany(typeof(NetworkManagerWTS), this, "OnClientDisconnect_", conn);
    }
