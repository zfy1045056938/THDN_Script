...
class characters
    ...
    public float exp { get; set; }
        ...
        public float CEagleEyes { get; set; }
        //KissAss
...
public class DatabaseTHDN:MonoBehaviour{
 ...
 players.leader = row.leaderLevel;
            ...
            */
                ...
                players.CSoulView = row.CSoulView;
...
//
    ...
    public void SaveDungeon(Players p)
    {
        ...
        if (p != null)
        {
                ...
                for (int i = 0; i < p.dungeon.Count; i++)
                {
                    DungeonAsset dungeon = p.dungeon[i];
                   
                        sqlConect.InsertOrReplace(new character_dungeon()
                        {
                            dungeonName = dungeon.name,
                            hasExplore = dungeon.hasExplore,
                            unlock = dungeon.unlockstate,
