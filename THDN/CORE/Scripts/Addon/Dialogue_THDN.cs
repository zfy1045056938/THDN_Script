...
public class Dialogue_THDN : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        //
         Lua.RegisterFunction("ShrineModule",this,SymbolExtensions.GetMethodInfo(()=>ShrineModule()));
    }
    ...
    //Select One Of Skill or Effect for player 
    public void ShrineModule(){
        var shrineUI = FindObjectOfType<TownManager>();
        if(shrineUI){
            shrineUI.shrineManager.LoadShrineList();
        }
    }
