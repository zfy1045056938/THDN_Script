...
namespace Invector.vItemManager
{
    ...
    public class vContainsItemTrigger : vMonoBehaviour
    {
        ...
        void Start(){
            itemManager = FindObjectOfType<vItemManager>().GetComponent<vItemManager>();
        }
        ...
        public virtual void CheckItem(vItemManager itemManager)
        {
        ...
        public bool ContainsItem(vItemManager itemManager)
        {
