...
namespace Invector.vCharacterController
{
    public class vHUDController : MonoBehaviour
    {
        ...
        public ProgressBarPro healthSlider;
        public ProgressBarPro staminaSlider;

        public ProgressBarPro ManaSlider;
        ...
        public void Init(vThirdPersonController cc)
        {
            ...
            // }
            // staminaSlider.value =cc.maxStamina;


            // if (players.manaMax != staminaSlider.maxValue)
            // {
            //     ManaSlider.maxValue = players.manaMax;
                
            // }
            // ManaSlider.value =players.mana;
            ...
            healthSlider.Value = cc.MaxHealth;
            ManaSlider.Value =cc.MaxMana;
            staminaSlider.Value=cc.maxStamina;
            expSlider.Value = players.exp;
        }
        ...
        void UpdateSliders(vThirdPersonController cc)
        {
            ...
            if(cc.maxHealth != healthSlider.Value){
                healthSlider.SetValue(cc.currentHealth,cc.MaxHealth);
            }
           
ManaSlider.Value = cc.currentMana;
            
            //
             if(cc.MaxMana != ManaSlider.Value){
                ManaSlider.SetValue(cc.currentMana,cc.MaxMana);
            }
            //
            ...
            //
             if(cc.maxStamina != staminaSlider.Value){
                staminaSlider.SetValue(cc.currentStamina,cc.maxStamina);
            }
            //
             expSlider.Value =players.exp;

            //
             if(players.exp != players.expMax){
                expSlider.SetValue(players.exp,players.expMax);
            }else if(players.exp == players.expMax){
                expSlider.Value=0;
            }
            ...
            //  if (players.manaMax != ManaSlider.maxValue)
            // {
            //     ManaSlider.maxValue = Mathf.Lerp(ManaSlider.maxValue, players.manaMax, 2f * Time.fixedDeltaTime);
