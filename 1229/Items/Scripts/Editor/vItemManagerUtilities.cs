    ...
    public partial class vItemManagerUtilities
    {
        partial void _CreateDefaultEquipPoints(vItemManager itemManager, vMeleeManager meleeManager)
        {
            ...
            if (equipPointL == null)
            {
                ...
                {
#if UNITY_EDITOR
                    UnityEventTools.AddPersistentListener<vMeleeWeapon>(pointL.onInstantiateEquiment, meleeManager.SetLeftWeapon);
#else
            ...
            else
            {
                ...
                {
#if UNITY_EDITOR
                    UnityEventTools.AddPersistentListener<vMeleeWeapon>(equipPointL.onInstantiateEquiment, meleeManager.SetLeftWeapon);
#else
            ...
            if (equipPointR == null)
            {
                ...
                {
#if UNITY_EDITOR
                    UnityEventTools.AddPersistentListener<vMeleeWeapon>(pointR.onInstantiateEquiment, meleeManager.SetRightWeapon);
#else
            ...
            else
            {
                ...
                {
#if UNITY_EDITOR
                    UnityEventTools.AddPersistentListener<vMeleeWeapon>(equipPointR.onInstantiateEquiment, meleeManager.SetRightWeapon);
#else
