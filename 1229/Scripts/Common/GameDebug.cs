...
/// <summary>
/// battle logs, every matches combat ,skills write line to logs
/// 1.matches ,when maches target auto atk to enemy und print the message (MATCHESMESSAGE::player deal ** to target )
/// 2.combat(COMBATMESSAGE:: )
/// 3.skill(SKILLMESSAGE:: ** use ** to **,(if check perc) ** )
/// </summary>
public static class GameDebug
{
    static System.IO.StreamWriter logFile = null;
    public static  LiveSkillType liveSkill = LiveSkillType.None;    //LS
    public static ElementDamageType edt = ElementDamageType.None;  //EDT
