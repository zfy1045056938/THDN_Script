...
public List<TMP_Dropdown.OptionData> opd = new List<TMP_Dropdown.OptionData>();
    void Start()
    {
    ...
    void Update(){
        ...
        BattleStartInfo.GameDifficult = dropdown.value;
    ...
    void InitDifficult(){
      opd.Add(new TMP_Dropdown.OptionData());
        //
       
                dropdown.options = dif.Select(dif=>new TMP_Dropdown.OptionData(dif)).ToList();
